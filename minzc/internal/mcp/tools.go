...
func (s *Server) getExtendedTools() []map[string]interface{} {
	baseTools := []map[string]interface{}{
		...
		{
			"name":        "ask_gpt4",
			"description": "Ask GPT-4.1 Turbo - CONTEXT: 1M tokens, STRENGTHS: Large file analysis, full codebase understanding, comprehensive documentation review. Use for: analyzing entire semantic analyzer, processing multiple large source files, understanding complex architectural relationships",
			"inputSchema": map[string]interface{}{
				"type": "object",
				"properties": map[string]interface{}{
					"question": map[string]interface{}{
