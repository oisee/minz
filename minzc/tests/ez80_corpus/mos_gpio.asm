; Source: https://github.com/breakintoprogram/agon-mos/blob/main/src/gpio.asm
; License: MIT (https://github.com/breakintoprogram/agon-mos)
; Author: Dean Belfield
; Description: AGON MOS GPIO pin mode configuration.
;              Uses SET_GPIO/RES_GPIO macros (IN0/OUT0 under the hood).
;              SWITCH_A jump table for mode selection.
