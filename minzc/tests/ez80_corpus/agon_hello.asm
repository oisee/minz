; Source: https://github.com/envenomator/agon-ez80asm/blob/master/tests/Z_PRG_AgonBits_Lessons/tests/hello.s
; License: MIT (https://github.com/envenomator/agon-ez80asm)
; Description: Agon Light "Hello World" - minimal eZ80 ADL mode program.
;              Demonstrates RST.LIL $18 (MOS API call from ADL mode).
