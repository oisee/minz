...
func generateZ80Patterns(m *MachineDesc) []Pattern {
	return []Pattern{
		...
		// INC/DEC (any GPR, in-place)
		{Name: "inc_r", Op: OpAdd, Width: 8, DstLocs: Z80_GPR8,
			SrcLocs: [2]LocSet{Z80_GPR8, Z80_GPR8},
			Template: "INC {dst}", Cost: 4, Bytes: 1},
		{Name: "dec_r", Op: OpSub, Width: 8, DstLocs: Z80_GPR8,
			SrcLocs: [2]LocSet{Z80_GPR8, Z80_GPR8},
		...
		{Name: "add_hl_rr", Op: OpAdd, Width: 16, DstLocs: Z80_HL,
			...
			Template: "ADD HL, {src1}", Cost: 11, Bytes: 1, Clobbers: Z80_Flags},
		{Name: "sbc_hl_rr", Op: OpSub, Width: 16, DstLocs: Z80_HL,
			SrcLocs: [2]LocSet{Z80_HL, Z80_BC.Or(Z80_DE).Or(Z80_HL)},
			Template: "OR A\n    SBC HL, {src1}", Cost: 19, Bytes: 3, Clobbers: Z80_Flags},
		{Name: "inc_rr", Op: OpAdd, Width: 16, DstLocs: Z80_Pairs,
			SrcLocs: [2]LocSet{Z80_Pairs, Z80_Pairs},
		...
		{Name: "sla_a", Op: OpShl, Width: 8, DstLocs: Z80_A,
			SrcLocs: [2]LocSet{Z80_A, Z80_GPR8},
			Template: "SLA A", Cost: 8, Bytes: 2, Clobbers: Z80_Flags},
		{Name: "srl_a", Op: OpShr, Width: 8, DstLocs: Z80_A,
			SrcLocs: [2]LocSet{Z80_A, Z80_GPR8},
			Template: "SRL A", Cost: 8, Bytes: 2, Clobbers: Z80_Flags},
		{Name: "shl16_hl", Op: OpShl, Width: 16, DstLocs: Z80_HL,
			SrcLocs: [2]LocSet{Z80_HL, Z80_GPR8},
			Template: "ADD HL, HL", Cost: 11, Bytes: 1, Clobbers: Z80_Flags},
		...
		{Name: "neg_a", Op: OpNeg, Width: 8, DstLocs: Z80_A,
			SrcLocs: [2]LocSet{Z80_A},
			Template: "NEG", Cost: 8, Bytes: 2, Clobbers: Z80_Flags},
