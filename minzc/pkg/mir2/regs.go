...
const (
	...
	ClassRegC                    // Z80=C register (hard pin for @z80_c)
	ClassRegD                    // Z80=D register (hard pin for @z80_d)
	ClassRegE                    // Z80=E register (hard pin for @z80_e)
	ClassRegH                    // Z80=H register (hard pin for @z80_h)
	ClassRegL                    // Z80=L register (hard pin for @z80_l)
...
func (c RegClass) Tier() int {
	switch c {
	case ClassGeneral, ClassAcc, ClassCounter, ClassRegC, ClassRegD, ClassRegE, ClassRegH, ClassRegL, ClassPointer, ClassIndex, ClassPair, ClassDWord:
		return 0
