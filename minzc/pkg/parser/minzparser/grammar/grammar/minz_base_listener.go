...
// EnterLogMetafunction is called when production logMetafunction is entered.
func (s *BaseMinZListener) EnterLogMetafunction(ctx *LogMetafunctionContext) {}

// ExitLogMetafunction is called when production logMetafunction is exited.
func (s *BaseMinZListener) ExitLogMetafunction(ctx *LogMetafunctionContext) {}
