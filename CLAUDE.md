...
| Frill (.frl) | ML-style functional: let, if/then/else, pipe \|>, match, ADT, lambda, where, recursion. 52+ compile-time asserts. See [Frill Guide](docs/Frill_Language_Guide.md) |
