...
\urlstyle{same}
\hypersetup{
  pdftitle={The Nanz Language Book --- v4.1},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{The Nanz Language Book --- v4.1}
\author{}
\date{2026-03-14}
...
v4.1}\label{the-nanz-language-book-v4.1}
...
\textbf{Version:} MinZ compiler v0.19.6+ (commit e5eb28a) \textbf{Date:}
2026-03-14 \textbf{Status:} Core features stable · 24/24 showcase ·
20/20 test packages
...
\item
  \hyperref[chapter-7-compile-time-assertions-and-sandbox-blocks]{Compile-Time
...
\item
  \hyperref[chapter-15-memory-management-arena-allocators]{Memory
...
\item
  \hyperref[appendix-e-whats-new-in-v41]{Appendix E: What's New in v4.1}
\end{itemize}
